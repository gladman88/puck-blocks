...
function FilterBar({ filters, categories, onChange, strings: t, locale }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-filterbar", children: [
    /* @__PURE__ */ jsxRuntime.jsxs("section", { className: `sb-filterbar__availability ${hasCompleteDateRange ? "is-ready" : "is-pending"}`, "aria-label": t.availabilityTitle, children: [
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-filterbar__availability-head", children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("label", { className: `sb-filterbar__availability-toggle${hasCompleteDateRange ? "" : " is-disabled"}`, children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            "input",
            {
              type: "checkbox",
    ...
    state === "ready" && (displayGroups.length === 0 ? /* @__PURE__ */ jsxRuntime.jsx("p", { className: "sb-vcatalog__state", children: t.empty }) : /* @__PURE__ */ jsxRuntime.jsx("div", { className: "sb-vcatalog__grid", children: displayGroups.map((g) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsx("button", { type: "button", className: "sb-vcard", onClick: () => setSelected(v), children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-vcard__media", children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-vcard__overlay", children: [
          !v.is_available ? /* @__PURE__ */ jsxRuntime.jsxs("span", { className: `sb-vcard__status ${v.free_from ? "sb-vcard__status--free" : ""}`, children: [
