...
function Section({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("section", { className: `sb-section ${className}`.trim(), children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: `sb-container ${containerClassName}`.trim(), children }) });
}
...
function AboutPromo({ heading, text, image, imagePosition = "right" }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Section, { className: imagePosition === "left" ? "sb-about--reverse" : "", children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-about__grid", children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "sb-about__media", children: /* @__PURE__ */ jsxRuntime.jsx("img", { className: "sb-about__img", src: img, alt: heading, loading: "lazy" }) }),
    body
  ] }) });
}
...
function ReviewsCarousel({ heading, images }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(Section, { children: [
    heading ? /* @__PURE__ */ jsxRuntime.jsx("h2", { className: "sb-h2", children: heading }) : null,
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "sb-reviews__track", children: safe.map((image, index) => /* @__PURE__ */ jsxRuntime.jsx("div", { className: "sb-reviews__item", children: /* @__PURE__ */ jsxRuntime.jsx("img", { className: "sb-reviews__img", src: image.src, alt: image.alt ?? "", loading: "lazy" }) }, index)) })
  ] });
}
var base = {
  className: "sb-ico",
