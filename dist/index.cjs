...
function InstagramMark({ className }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("svg", { className: `${className} sb-ico--instagram`, viewBox: "0 0 32 32", "aria-hidden": "true", children: [
    /* @__PURE__ */ jsxRuntime.jsx("defs", { children: /* @__PURE__ */ jsxRuntime.jsxs("radialGradient", { id: gradientId, cx: "30%", cy: "107%", r: "150%", children: [
      /* @__PURE__ */ jsxRuntime.jsx("stop", { offset: "0%", stopColor: "#fdf497" }),
      /* @__PURE__ */ jsxRuntime.jsx("stop", { offset: "18%", stopColor: "#fd5949" }),
      /* @__PURE__ */ jsxRuntime.jsx("stop", { offset: "48%", stopColor: "#d6249f" }),
      /* @__PURE__ */ jsxRuntime.jsx("stop", { offset: "78%", stopColor: "#285aeb" }),
      /* @__PURE__ */ jsxRuntime.jsx("stop", { offset: "100%", stopColor: "#833ab4" })
    ] }) }),
    /* @__PURE__ */ jsxRuntime.jsx("circle", { cx: "16", cy: "16", r: "16", fill: `url(#${gradientId})` }),
    /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "7", y: "7", width: "18", height: "18", rx: "5.5", fill: "none", stroke: "#fff", strokeWidth: "2.25" }),
    /* @__PURE__ */ jsxRuntime.jsx("circle", { cx: "16", cy: "16", r: "4.1", fill: "none", stroke: "#fff", strokeWidth: "2.25" }),
    /* @__PURE__ */ jsxRuntime.jsx("circle", { cx: "21.7", cy: "10.4", r: "1.45", fill: "#fff" })
  ] });
}
function ContactIcon({ kind, className }) {
  const iconClass = iconClassName(className);
  if (kind === "instagram") {
    return /* @__PURE__ */ jsxRuntime.jsx(InstagramMark, { className: iconClass });
  }
  if (kind === "telegram") {
    return /* @__PURE__ */ jsxRuntime.jsx("svg", { className: iconClass, viewBox: "0 0 24 24", fill: "currentColor", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: telegramPlanePath, transform: "translate(-9 -9) scale(1.75)" }) });
  }
  if (kind === "whatsapp") {
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-hero__inner", children: [
          ...
          hasCta || wa || tg ? /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-hero__cta", children: [
            ...
            wa || tg ? (
              ...
              /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-hero__socials", children: [
...
function DeliveryAddressPicker({ apiKey, value, onSelect, strings }) {
  const [query, setQuery] = react.useState(() => displayValue(value));
  ...
  const suggestApiRef = react.useRef(null);
  const sessionTokenCtorRef = react.useRef(null);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-vd__addr-picker-inner", children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-vd__addr-search", children: [
      ...
      open && suggestions.length > 0 ? /* @__PURE__ */ jsxRuntime.jsx("ul", { className: "sb-vd__addr-suggest", "data-testid": "delivery-address-suggestions", children: suggestions.map((p, i) => /* @__PURE__ */ jsxRuntime.jsx("li", { children: /* @__PURE__ */ jsxRuntime.jsxs("button", { type: "button", onMouseDown: (e) => e.preventDefault(), onClick: () => selectPrediction(p), children: [
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "sb-vd__addr-suggest-main", children: p.mainText?.text ?? p.text.toString() }),
        p.secondaryText?.text ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "sb-vd__addr-suggest-sub", children: p.secondaryText.text }) : null
      ] }) }, i)) }) : null
    ] }),
    ...
    status === "ready" ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      ...
      mapOpen ? /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-vd__addr-map-wrap", children: [
        /* @__PURE__ */ jsxRuntime.jsx("div", { ref: mapDivRef, className: "sb-vd__addr-map", "data-testid": "delivery-address-map" }),
        /* @__PURE__ */ jsxRuntime.jsx("p", { className: "sb-vd__addr-map-hint", children: strings.mapHint })
      ] }) : null
    ] }) : null
  ] });
}
...
function VehicleBookingModal({
  ...
  const [dragSmooth, setDragSmooth] = react.useState(false);
  const onGrabStart = (e) => {
  ...
  const renderAccessories = () => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-vd__accessories", children: [
      /* @__PURE__ */ jsxRuntime.jsx("span", { className: "sb-vd__section-label", children: t.accessories }),
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "sb-acc__row", children: d.accessories.flatMap(
        (group) => group.items.map((item) => {
          ...
          return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `sb-acc__item ${unavailable ? "is-unavailable" : ""}`, children: [
            /* @__PURE__ */ jsxRuntime.jsx("span", { className: "sb-acc__item-category", children: categoryName }),
            item.photo_url ? (
              ...
              /* @__PURE__ */ jsxRuntime.jsxs(
                "button",
                {
                  ...
                  "aria-label": itemName,
                  children: [
                    /* @__PURE__ */ jsxRuntime.jsx("img", { src: safeImageUrl(item.photo_url ?? void 0), alt: itemName }),
                    /* @__PURE__ */ jsxRuntime.jsx("span", { className: "sb-acc__item-expand", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntime.jsxs("svg", { viewBox: "0 0 24 24", width: "12", height: "12", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
                      /* @__PURE__ */ jsxRuntime.jsx("path", { d: "m21 21-6-6m6 6v-4.8m0 4.8h-4.8" }),
                      /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M3 16.2V21m0 0h4.8M3 21l6-6" }),
                      /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M21 7.8V3m0 0h-4.8M21 3l-6 6" }),
                      /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M3 7.8V3m0 0h4.8M3 3l6 6" })
                    ] }) })
                  ]
                }
              )
            ) : /* @__PURE__ */ jsxRuntime.jsx("div", { className: "sb-acc__item-photo" }),
            /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-acc__item-info", children: [
              /* @__PURE__ */ jsxRuntime.jsx("span", { className: "sb-acc__item-name", children: itemName }),
              item.price != null ? /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "sb-acc__item-price", children: [
              ...
              unavailable ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "sb-acc__item-unavailable", children: t.accUnavailable }) : null
            ] }),
            /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-acc__stepper", children: [
              /* @__PURE__ */ jsxRuntime.jsx(
                "button",
                {
                  type: "button",
              ...
              /* @__PURE__ */ jsxRuntime.jsx("span", { className: "sb-acc__stepper-value", children: qty }),
              /* @__PURE__ */ jsxRuntime.jsx(
                "button",
                {
                  type: "button",
  ...
  return reactDom.createPortal(
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-root", children: [
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "sb-modal", role: "dialog", "aria-modal": "true", onClick: onClose, children: /* @__PURE__ */ jsxRuntime.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntime.jsx("span", { className: "sb-modal__grabber-bar", "aria-hidden": true })
              }
            ),
            ...
            state === "ready" && d ? stage === "success" ? /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-modal__success", children: [
              ...
              gallery.length > 0 ? /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-vd__media", children: [
                /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-vd__gallery", children: [
                  /* @__PURE__ */ jsxRuntime.jsx("div", { className: "sb-vd__frame", ref: trackRef, onScroll: onTrackScroll, children: gallery.map((u, i) => /* @__PURE__ */ jsxRuntime.jsx(
                    "img",
                    {
                  ...
                  gallery.length > 1 ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntime.jsx(
                      "button",
                      {
                        type: "button",
                ...
                gallery.length > 1 ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "sb-vd__thumbs", children: gallery.map((u, i) => /* @__PURE__ */ jsxRuntime.jsx(
                  "button",
                  {
                    type: "button",
              ...
              /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-vd__info", children: [
                /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-vd__header", children: [
                  /* @__PURE__ */ jsxRuntime.jsx("h3", { className: "sb-vd__name", children: d.display_name }),
                ...
                /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-vd__meta-row", children: [
                  d.year ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "sb-vd__year", children: d.year }) : null,
                  d.category ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "sb-vd__badge", style: { backgroundColor: d.category.color }, children: categoryLabel(d.category, locale) }) : null,
                  /* @__PURE__ */ jsxRuntime.jsxs(
                    "button",
                    {
                      type: "button",
                        ...
                        /* @__PURE__ */ jsxRuntime.jsxs(
                          "svg",
                          {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ jsxRuntime.jsx("line", { x1: "8.6", y1: "13.5", x2: "15.4", y2: "17.5" }),
                              /* @__PURE__ */ jsxRuntime.jsx("line", { x1: "15.4", y1: "6.5", x2: "8.6", y2: "10.5" })
                            ]
                          }
                        ),
            ...
            ] }) : stage === "choice" ? /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-modal__body sb-modal__body--book", children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx("h3", { className: "sb-bk__title", children: t.formTitle }),
              /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-bk__vehicle", children: [
                mainImg ? /* @__PURE__ */ jsxRuntime.jsx("img", { className: "sb-bk__photo", src: mainImg, alt: "" }) : null,
                /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-bk__meta", children: [
                  /* @__PURE__ */ jsxRuntime.jsx("p", { className: "sb-bk__name", children: d.display_name }),
              ...
              /* @__PURE__ */ jsxRuntime.jsxs("form", { className: "sb-vd__book", onSubmit: submit, children: [
                /* @__PURE__ */ jsxRuntime.jsxs("label", { className: "sb-vd__field", children: [
                  /* @__PURE__ */ jsxRuntime.jsx("span", { className: "sb-vd__field-label", children: t.name }),
                  /* @__PURE__ */ jsxRuntime.jsx(
                    "input",
                    {
                      className: "sb-input",
                ...
                /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-vd__field", children: [
                  ...
                  contactError ? /* @__PURE__ */ jsxRuntime.jsx("span", { id: "sb-vd-contact-error", className: "sb-vd__field-error", children: contactError }) : null
                ] }),
                /* @__PURE__ */ jsxRuntime.jsxs("p", { className: "sb-vd__dates-summary", children: [
                  t.dateGet,
                  ": ",
                  /* @__PURE__ */ jsxRuntime.jsx("b", { children: formatShortDate(start, locale) }),
                  " \u2014 ",
                  t.dateReturn,
                  ": ",
                  /* @__PURE__ */ jsxRuntime.jsx("b", { children: formatShortDate(end, locale) })
                ] }),
                effectivePickupLocation ? /* @__PURE__ */ jsxRuntime.jsxs("p", { className: "sb-vd__dates-summary", children: [
                  t.deliveryPickup,
                  ": ",
                  /* @__PURE__ */ jsxRuntime.jsx("b", { children: effectivePickupLocation.address })
                ] }) : null,
                effectiveDropoffLocation ? /* @__PURE__ */ jsxRuntime.jsxs("p", { className: "sb-vd__dates-summary", children: [
                  t.deliveryDropoff,
                  ": ",
                  /* @__PURE__ */ jsxRuntime.jsx("b", { children: effectiveDropoffLocation.address })
                ] }) : null,
                /* @__PURE__ */ jsxRuntime.jsx(
                  "button",
                  {
      ...
      accessoryLightbox ? /* @__PURE__ */ jsxRuntime.jsxs(
        "div",
        {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsx("section", { className: `sb-filterbar__availability ${hasCompleteDateRange ? editingDates ? "is-ready is-editing" : "is-ready is-compact" : "is-pending"}`, "aria-label": t.availabilityTitle, children: hasCompleteDateRange && !editingDates ? /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-filterbar__availability-compact", children: [
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-filterbar__availability-summary", children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "sb-filterbar__availability-title", children: t.availabilityTitle }),
        /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "sb-filterbar__availability-range", children: [
          formatDDMMYYYY(filters.availableFrom),
          " \u2014 ",
          formatDDMMYYYY(filters.availableTo)
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntime.jsx("button", { type: "button", className: "sb-filterbar__availability-edit", onClick: () => setEditingDates(true), children: t.editDates }),
      /* @__PURE__ */ jsxRuntime.jsxs("label", { className: "sb-filterbar__availability-toggle", children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          "input",
          {
            type: "checkbox",
        ...
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "sb-filterbar__availability-switch", "aria-hidden": true }),
        /* @__PURE__ */ jsxRuntime.jsx("span", { children: t.availableOnly })
      ] })
    ] }) : /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-filterbar__availability-head", children: [
        /* @__PURE__ */ jsxRuntime.jsx("div", { children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-filterbar__availability-title", children: [
          /* @__PURE__ */ jsxRuntime.jsxs("svg", { viewBox: "0 0 24 24", width: "18", height: "18", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": true, children: [
            /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "3", y: "4", width: "18", height: "18", rx: "2" }),
            /* @__PURE__ */ jsxRuntime.jsx("line", { x1: "16", y1: "2", x2: "16", y2: "6" }),
            /* @__PURE__ */ jsxRuntime.jsx("line", { x1: "8", y1: "2", x2: "8", y2: "6" }),
      ...
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-filterbar__daterange", children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-filterbar", children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-filterbar__row", children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          "button",
          {
            type: "button",
        ...
        categories.length > 0 ? /* @__PURE__ */ jsxRuntime.jsxs(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsxs("svg", { viewBox: "0 0 24 24", width: "12", height: "12", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": true, children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx("circle", { cx: "8", cy: "6", r: "1.5", fill: "currentColor", stroke: "none" }),
                /* @__PURE__ */ jsxRuntime.jsx("circle", { cx: "16", cy: "12", r: "1.5", fill: "currentColor", stroke: "none" }),
                /* @__PURE__ */ jsxRuntime.jsx("circle", { cx: "10", cy: "18", r: "1.5", fill: "currentColor", stroke: "none" })
              ] }),
      ...
      categoryOpen ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "sb-filterbar__categories", children: categories.map((cat) => /* @__PURE__ */ jsxRuntime.jsx(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "sb-filterbar__row sb-filterbar__row--utilities", children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-filterbar__actions", children: [
        /* @__PURE__ */ jsxRuntime.jsxs("button", { type: "button", className: "sb-filterbar__sort", onClick: cycleSort, children: [
          /* @__PURE__ */ jsxRuntime.jsxs("svg", { viewBox: "0 0 24 24", width: "12", height: "12", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": true, children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx("line", { x1: "3", y1: "12", x2: "7", y2: "12" }),
            /* @__PURE__ */ jsxRuntime.jsx("line", { x1: "3", y1: "18", x2: "5", y2: "18" }),
            /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M17 4v16m0 0-4-4m4 4 4-4" })
          ] }),
          /* @__PURE__ */ jsxRuntime.jsx("span", { className: filters.sort !== "default" ? "sb-filterbar__sort-active" : "", children: sortLabel })
        ] }),
        hasActiveFilters ? /* @__PURE__ */ jsxRuntime.jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsxs("svg", { viewBox: "0 0 24 24", width: "12", height: "12", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": true, children: [
              /* @__PURE__ */ jsxRuntime.jsx("line", { x1: "18", y1: "6", x2: "6", y2: "18" }),
              /* @__PURE__ */ jsxRuntime.jsx("line", { x1: "6", y1: "6", x2: "18", y2: "18" })
            ] })
          }
...
function VehicleCatalog({
  ...
  const [categories, setCategories] = react.useState(preload?.categories ?? []);
  const [vehicles, setVehicles] = react.useState(preloadedVehicles ?? []);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(Section, { className: "sb-vcatalog", id: anchorId || void 0, children: [
    ...
    state === "ready" && (displayGroups.length === 0 ? /* @__PURE__ */ jsxRuntime.jsx("p", { className: "sb-vcatalog__state", children: t.empty }) : /* @__PURE__ */ jsxRuntime.jsx("div", { className: "sb-vcatalog__grid", children: displayGroups.map((g) => {
      const v = g.vehicle;
      ...
      return /* @__PURE__ */ jsxRuntime.jsx("button", { type: "button", className: "sb-vcard", onClick: () => setSelected(v), children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-vcard__media", children: [
        ...
        v.category && (showFilters || activeCat === null) ? (
          ...
          /* @__PURE__ */ jsxRuntime.jsx("span", { className: "sb-vcard__badge", style: { backgroundColor: v.category.color }, children: categoryLabel(v.category, locale) })
        ) : null,
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-vcard__overlay", children: [
          /* @__PURE__ */ jsxRuntime.jsxs("span", { className: `sb-vcard__status ${v.is_available ? "sb-vcard__status--available" : v.free_from ? "sb-vcard__status--free" : ""}`, children: [
            /* @__PURE__ */ jsxRuntime.jsx("span", { className: "sb-vcard__status-dot", "aria-hidden": true }),
...
function imageField(label) {
  return {
    ...
    render: ({ value, onChange }) => /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sbf-field", children: [
      /* @__PURE__ */ jsxRuntime.jsx("span", { className: "sbf-field__label", children: label }),
      /* @__PURE__ */ jsxRuntime.jsx(ImageInput, { value: value ?? "", onChange: (next) => onChange(next) })
    ] })
  };
}
var __catTabsCache = {};
