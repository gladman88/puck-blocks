...
function StatCounters({ heading, items }) {
  return /* @__PURE__ */ jsxRuntime.jsxs(Section, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "sb-stats__grid", children: (items ?? []).map((item, index) => /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-stat", children: [
...
function FeatureCards({ heading, items }) {
  return /* @__PURE__ */ jsxRuntime.jsxs(Section, { children: [
    heading ? /* @__PURE__ */ jsxRuntime.jsx("h2", { className: "sb-h2", children: heading }) : null,
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "sb-features__grid", children: (items ?? []).map((item, index) => {
      const icon = safeImageUrl(item.icon);
      return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-feature", children: [
...
function Stars({ rating }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "sb-review__stars", "aria-label": `${full} \u0438\u0437 5`, children: [
    "\u2605\u2605\u2605\u2605\u2605".slice(0, full),
    /* @__PURE__ */ jsxRuntime.jsx("span", { className: "sb-review__stars-empty", children: "\u2605\u2605\u2605\u2605\u2605".slice(0, 5 - full) })
  ] });
}
function ReviewCard({ review }) {
  const hasHead = Boolean(review.name || review.avatar || review.rating);
  return /* @__PURE__ */ jsxRuntime.jsxs("article", { className: "sb-review", children: [
    review.videoUrl ? /* @__PURE__ */ jsxRuntime.jsx(
      VideoEmbed,
      {
        url: review.videoUrl,
        title: review.name ? `\u0412\u0438\u0434\u0435\u043E-\u043E\u0442\u0437\u044B\u0432 \u2014 ${review.name}` : "\u0412\u0438\u0434\u0435\u043E-\u043E\u0442\u0437\u044B\u0432"
      }
    ) : review.photo ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "sb-review__media", children: /* @__PURE__ */ jsxRuntime.jsx(
      "img",
      {
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-review__body", children: [
      hasHead ? /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-review__head", children: [
        review.avatar ? /* @__PURE__ */ jsxRuntime.jsx("img", { className: "sb-review__avatar", src: review.avatar, alt: "", loading: "lazy" }) : null,
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-review__meta", children: [
          review.name ? /* @__PURE__ */ jsxRuntime.jsx("p", { className: "sb-review__name", children: review.name }) : null,
          review.rating ? /* @__PURE__ */ jsxRuntime.jsx(Stars, { rating: review.rating }) : null
        ] })
      ] }) : null,
      review.text ? /* @__PURE__ */ jsxRuntime.jsx("p", { className: "sb-review__text", children: review.text }) : null
    ] })
  ] });
}
function ReviewsCarousel({ heading, anchorId, reviews }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(Section, { id: anchorId || "reviews", children: [
    heading ? /* @__PURE__ */ jsxRuntime.jsx("h2", { className: "sb-h2", children: heading }) : null,
    safe.length > 0 ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "sb-reviews-grid", children: safe.map((r, i) => /* @__PURE__ */ jsxRuntime.jsx(ReviewCard, { review: r }, i)) }) : null
  ] });
}
var base = {
  className: "sb-ico",
...
function Footer({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("footer", { className: "sb-footer", id: "contacts", children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-footer__inner", children: [
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-footer__col", children: [
        /* @__PURE__ */ jsxRuntime.jsx("h4", { children: "\u041A\u043E\u043D\u0442\u0430\u043A\u0442\u044B" }),
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-footer__list", children: [
          ...
          mapHref ? /* @__PURE__ */ jsxRuntime.jsx("a", { href: mapHref, target: "_blank", rel: "noopener noreferrer", children: "\u041D\u0430 \u043A\u0430\u0440\u0442\u0435" }) : null
        ] })
      ] }),
      navLinks.length > 0 ? /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-footer__col", children: [
        /* @__PURE__ */ jsxRuntime.jsx("h4", { children: "\u041D\u0430\u0432\u0438\u0433\u0430\u0446\u0438\u044F" }),
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "sb-footer__list", children: navLinks.map((link, index) => /* @__PURE__ */ jsxRuntime.jsx("a", { href: link.href, children: link.label }, index)) })
      ] }) : null,
      socials.length > 0 ? /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "sb-footer__col", children: [
        /* @__PURE__ */ jsxRuntime.jsx("h4", { children: "\u041C\u044B \u0432 \u0441\u043E\u0446\u0441\u0435\u0442\u044F\u0445" }),
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "sb-footer__socials", children: socials.map((social, index) => /* @__PURE__ */ jsxRuntime.jsx(
          "a",
          {
            className: "sb-icon-link",
            href: social.href,
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx(ContactIcon, { kind: social.kind })
          },
          index
        )) })
      ] }) : null
...
function VehicleCatalog({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(Section, { className: "sb-vcatalog", children: [
    ...
    state === "ready" && (groups.length === 0 ? /* @__PURE__ */ jsxRuntime.jsx("p", { className: "sb-vcatalog__state", children: t.empty }) : /* @__PURE__ */ jsxRuntime.jsx("div", { className: "sb-vcatalog__grid", children: groups.map((g) => {
      ...
      return href ? /* @__PURE__ */ jsxRuntime.jsx("a", { className: "sb-vcard", href, children: media }, v.id) : /* @__PURE__ */ jsxRuntime.jsx("div", { className: "sb-vcard", children: media }, v.id);
    }) })),
    state === "ready" && base2 ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "sb-vcatalog__foot", children: /* @__PURE__ */ jsxRuntime.jsx("a", { className: "sb-btn sb-btn--ghost", href: base2, children: t.viewAll }) }) : null
  ] });
}
